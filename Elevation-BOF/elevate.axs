...
var cmd_printspoofer = ax.create_command("printspoofer", "PrintSpoofer - Local Privilege Escalation via Print Spooler (Named Pipe Impersonation)", "printspoofer --token");
